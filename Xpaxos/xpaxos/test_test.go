...
func TestByzantineFault1(t *testing.T) {
	...
	cfg.xpServers[1].byzantine = true
	//cfg.xpServers[0].byzantine = true
...
func TestByzantineFault2(t *testing.T) {
	...
	// so many failure but it can past the test....
	cfg.xpServers[2].byzantine = true
	cfg.xpServers[4].byzantine = true
	cfg.xpServers[6].byzantine = true
	cfg.xpServers[5].byzantine = true
	cfg.xpServers[1].byzantine = true
	cfg.xpServers[3].byzantine = true
	cfg.xpServers[7].byzantine = true
