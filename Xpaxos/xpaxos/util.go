...
// 这个函数，msgDigest是代表xp对client request明文生成的摘要，而signature是第server发给我的签名，xp用server的公钥去解密
...
func (xp *XPaxos) generateSynchronousGroup(seed int64) {
	...
	//fmt.Println("r:::", r)
	numAdded := 0
	//fmt.Println("xp.getLeader()::", xp.getLeader())
